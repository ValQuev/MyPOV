...
/**
 * Created by ValQuev on 15/12/2015.
 */
public class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context) {
        ...
        if (intentList.size() > 0) {
            chooserIntent = Intent.createChooser(intentList.remove(intentList.size() - 1), "Sélectionnez une image");
    ...
    public static Bitmap getImageFromResult(Context context, int resultCode, Intent imageReturnedIntent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            bm = getImage(context, selectedImage);
    ...
    private static Bitmap getImage(Context context, Uri selectedImage) {
        Bitmap bm = null;
        try {
